...
| `CLASS_CALL_URL` | No (class call just won't show up without it) | Your Whereby room URL for the "Join/Start Class" video call feature |
...
7. **Set environment variables** on the Web Service (Render dashboard -> your service -> Environment):
   ...
   - `CLASS_CALL_URL` -- (optional) create a Whereby room, then set this to the room URL (looks like `https://your-subdomain.whereby.com/your-room-name`). Without this set, the "Join/Start Class" button just won't appear.
